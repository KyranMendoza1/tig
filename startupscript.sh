...
tmux new-session -d -s tig-session bash -c '
    ...
    ALGOS_TO_COMPILE="satisfiability_sat_optima vehicle_routing_cw_heuristic knapsack_quick_knap vector_search_optimax_gpu"
    ...
    SELECTED_ALGORITHMS='"'"'{"satisfiability":"sat_optima","vehicle_routing":"cw_heuristic","knapsack":"quick_knap","vector_search":"optimax_gpu"}'"'"'
